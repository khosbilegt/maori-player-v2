          ...
          <div className="bg-card rounded-lg border shadow-sm p-8 md:p-12">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                We&rsquo;re committed to protecting your personal information
            ...
            <div className="prose prose-lg max-w-none">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-muted-foreground">
                      Tokotoko is currently in early testing. We only collect
                      the minimum data needed to run the platform and improve
                      your experience.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-muted border border-border rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground">
                    As we grow, we&rsquo;ll expand this policy and be
                ...
                <div className="space-y-4">
                  <div className="bg-muted border border-border rounded-lg p-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Username, email address, and encrypted password for
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted border border-border rounded-lg p-6">
                  <ul className="text-muted-foreground space-y-2 text-sm">
                    ...
                    <li>
                      • Access to personal data is limited to essential
                      personnel only
                    </li>
