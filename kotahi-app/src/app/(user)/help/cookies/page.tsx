          ...
          <div className="bg-card rounded-lg border shadow-sm p-8 md:p-12">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                We use cookies (small bits of data stored in your browser) to
                keep you logged in and make Tokotoko work smoothly. We
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <ul className="text-muted-foreground space-y-2 text-sm">
                        ...
                        <li>
                          • Track your learning progress and watch history
                        </li>
                ...
                <div className="bg-muted border-l-4 border-border p-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        We&rsquo;re committed to your privacy and don&rsquo;t
                        use cookies for:
                      </p>
                      <ul className="text-muted-foreground space-y-2 text-sm">
              ...
              <section className="mb-8">
                ...
                <div className="space-y-6">
                  <div className="bg-muted border border-border rounded-lg p-6">
                    ...
                    <p className="text-muted-foreground text-sm mb-2">
                      <strong>Duration:</strong> Until you log out or the
                      session expires
                    </p>
                  ...
                  <div className="bg-muted border border-border rounded-lg p-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      <strong>Data:</strong> Theme preference, language
                  ...
                  <div className="bg-muted border border-border rounded-lg p-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      <strong>Data:</strong> Video watch times, progress
                      markers, vocabulary interactions
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted border border-border rounded-lg p-6">
                  <p className="text-muted-foreground mb-4">
                    ...
                    However, disabling essential cookies may prevent Tokotoko
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted border border-border rounded-lg p-6">
                  <p className="text-muted-foreground">
                    As Tokotoko grows and we add new features, we may update
                    this cookie policy. We&rsquo;ll notify users of any
                    significant changes and update the date below.
                  </p>
                </div>
              </section>
