              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    These terms reflect our current stage and will be updated as
                    we grow and learn from our users.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <ul className="text-muted-foreground space-y-2 text-sm">
                        <li>
                          • Respect other users and maintain a positive learning
                          environment
                        </li>
                        <li>
                ...
                <div className="bg-muted border border-border rounded-lg p-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <ul className="text-muted-foreground space-y-2 text-sm">
                        <li>
                          • Features may be added, removed, or modified without
                          notice
                        </li>
                        <li>
            ...
            <section className="mt-8">
              ...
              <div className="bg-muted border border-border rounded-lg p-6">
                <p className="text-muted-foreground mb-4">
                  We collect minimal data needed to run the platform and improve
                  your experience. We will never sell your data to third
                  parties.
                </p>
                <p className="text-muted-foreground">
